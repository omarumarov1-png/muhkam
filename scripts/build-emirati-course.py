...
def main():
    ...
    course = {
        "id": "emirati",
        "title": "Khaleeji Arabic, Start to Fluent",
        "subtitle": "Pan-Gulf Khaleeji Arabic (UAE/Kuwait/Saudi Eastern Province/Bahrain/Qatar/Oman), from absolute beginner through fluent, everyday command",
        "dir": "rtl",
        "lang": "afb",
        "languageName": "Khaleeji Arabic",
        "fontNative": "'Noto Naskh Arabic', 'Noto Sans Arabic', serif",
        "flag": "خليجي",
        "heroEyebrow": "خليجي · A1 → C2",
        "heroNative": "من الألف للياء",
        "heroLedeSuffix": "Real spoken Khaleeji sentences from lesson one, with transliteration and native-style audio for every line.",
